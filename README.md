...
A scroll-driven, storytelling portfolio told in **six chapters** — with a full-page animated 3D background, chapter-by-chapter color worlds, and a route map that draws itself as you scroll.
...
Chapter background & blob colors live in each `<section>`'s `data-bg` / `data-b1..b4` attributes.
